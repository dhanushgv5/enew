// Country names with international calling (dial) codes.
// Used to populate the country dropdown in address forms and to
// auto-fill the phone field's dial-code prefix when a country is picked.
...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Northern Mariana Islands', dial: '+1670' },
  { name: 'Norway', dial: '+47' },
  { name: 'Oman', dial: '+968' },
  ...
  { name: 'Turks and Caicos Islands', dial: '+1649' },
  ...
  { name: 'United States Virgin Islands', dial: '+1340' },
